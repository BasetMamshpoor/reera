  ...
  return (
    <div className="hidden md:flex flex-row gap-2 lg:gap-4 items-center">
      ...
      >
        ...
        <button className="bg-black dark:bg-white px-6 py-2 rounded-lg flex items-center gap-2 cursor-pointer">
            <span className="text-white dark:text-black font-normal">ثبت آگهی</span>
