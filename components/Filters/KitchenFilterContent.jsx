...
const DigitalFilterContentMobile = ({
                                        categoryTree,
                                        filters,
                                        handleChange,
                                        priceRangeFromAPI,
    ...
    return (
        <div className="flex flex-col gap-4 p-6 lg:p-0 overflow-y-auto scrollbar-hide">
            {/* Categories */}
...
export default DigitalFilterContentMobile;
