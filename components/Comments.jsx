                    ...
                    visibleComments.map((item) => (
                        ...
                        >
                            <div className="flex w-full lg:gap-4 ">
                                <div className="mx-4 my-auto w-14 h-14 border-2 border-default-divider overflow-hidden rounded-full flex items-center justify-center">
                                    {item.user?.profile ? (
                                        <Image
                                    ...
                                    <div className="flex items-center w-full gap-4 justify-between">
                                        ...
                                        <div className="flex flex-col gap-4 lg:flex-row rtl:flex-row-reverse">
                                            <div className="flex flex-row rtl:flex-row-reverse items-center gap-4 ">
                                                <Reply refetch={refetch} id={item.id} />
