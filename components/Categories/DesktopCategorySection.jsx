...
const DesktopCategorySection = () => {
  ...
  return (
    <div className="hidden lg:flex flex-row gap-4 mt-10 ">
      <div className="flex flex-col gap-4  w-full h-42">
        <span className=" text-2xl font-[700]">دســـتــه‌بــنـدی‌هــای</span>

        <div className="flex flex-row items-center gap-2 rtl:self-start ltr:self-end w-full">
