...
const MobileSearch = () => {
  ...
  return (
    <div className="flex flex-col mt-6 items-center gap-4 md:hidden">
      ...
      >
        <SearchIcon className="absolute start-3 top-1/2 -translate-y-1/2 text-muted-foreground h-4 w-4 pointer-events-none transition-opacity duration-200 group-focus-within:opacity-0 fill-Gray-500" />
        {/* <Input
