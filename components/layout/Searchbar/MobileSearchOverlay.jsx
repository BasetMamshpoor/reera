...
const MobileSearchOverlay = ({ mobileSearchFocus, setMobileSearchFocus }) => {
  ...
  return (
    <Drawer open={mobileSearchFocus} onOpenChange={setMobileSearchFocus}>
      <DrawerContent className="bg-white dark:bg-[#252C36] rounded-t-2xl h-[70vh]">
        <DrawerHeader className="border-b border-gray-200 dark:border-[#374151] py-4">
          <div className="flex items-center justify-between px-2">
            ...
            {/* Close Button */}
            <DrawerClose asChild>
              <button className="ml-3 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition">
