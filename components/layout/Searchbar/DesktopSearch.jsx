  ...
  return (
    ...
    >
      ...
      <div className="flex-2">
        <Select>
          <SelectTrigger className="border-none text-[#000000] shadow-none font-[600]  text-md dark:bg-[#14181d] cursor-pointer">
      ...
      <div className="relative w-full group">
        ...
        <div className="relative w-full z-0">
          <Input
            className="placeholder:text-right py-6  placeholder:font-[200] placeholder:pr-8 border-gray-500 focus:placeholder-transparent focus:outline-none focus:ring-0 dark:bg-[#374151] focus:outline-0 dark:placeholder:text-white"
            placeholder="جستجو"
