    ...
    >
      <div className="flex items-center flex-row-reverse justify-between  py-6 gap-4 px-2">
        <div className="w-full relative group focus-within:ring-0">
          <SearchIcon className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground h-4 w-4 pointer-events-none transition-opacity duration-200 group-focus-within:opacity-0" />

          <Input
            className="placeholder:text-right py-3 placeholder:font-['yekanbakh'] placeholder:font-[200] placeholder:pr-6 border-gray-500 focus:placeholder-transparent focus:outline-none focus:ring-0 dark:bg-[#252C36]"
            placeholder="جستجو"
          />
        </div>
