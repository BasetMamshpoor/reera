...
import AdvsRes from "../ads/_components/AdvsRes";
import {QueryClient, dehydrate} from "@tanstack/react-query";
import Providers from "../Providers";
import {request} from "@/lib/api";
import Image from "next/image";
import ImageOverlay from "@/assets/images/wave-haikei-y.svg"
        ...
        <>
            <div className="container flex flex-col gap-16">
                <div className="flex items-center flex-col gap-1">
                    ...
                    <p className="text-4xl text-[#4299C1] font-bold">ریـــــرا</p>
                </div>
                            ...
                            <div
                                ...
                                <div className="flex flex-col p-2 gap-3">
                                    <div className="flex flex-col gap-1 pl-2 pb-2">
                                        <p className="text-sm text-[#3B3E46] dark:text-[#E0E2E5] font-bold">راهنمای
                                            اجاره خانه در ترکیه برای
                                            مهاران</p>
                                        <p className="text-sm text-gray-500 dark:text-white line-clamp-2">لورم ایپسوم
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="text-xs text-[#3B3E46] dark:text-[#E0E2E5]">استانبول،
                                                ترکیه
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Calender className="fill-gray-700 dark:fill-gray-300"/>
                                            <div className="text-xs text-[#3B3E46] dark:text-[#E0E2E5]">1404/2/12</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col gap-5 px-4 py-3 bg-white dark:bg-[#252C36]  border border-[#D1D5DB] dark:border-[#374151] rounded-xl ">
                                <div className="flex items-center gap-2 ">
                                    <Flash className="fill-gray-700 dark:fill-gray-300 w-5 h-5"/>
                                    <p className="text-sm text-[#3B3E46] dark:text-[#E0E2E5]">نیاز به کمک برای اجاره یا خرید دارید؟</p>
                                </div>
                                <Link href="/" className="flex items-center justify-center px-4 py-2  border border-[#4299C1] bg-white rounded-xl font-bold text-sm text-[#4299C1] ">
                                    درخواست مشاروه
                                </Link>
                            </div>
                        </div>
