...
export function LegalServicesPage() {
    ...
    const getDifficultyColor = (difficulty) => {
        switch (difficulty) {
            case 'آسان': return 'text-green-600 bg-green-50';
            case 'متوسط': return 'text-yellow-600 bg-yellow-50';
            case 'سخت': return 'text-red-600 bg-red-50';
    ...
    const getStepIcon = (step) => {
        switch (step) {
            ...
            case 3: return <Languages className="w-6 h-6" />;
            case 4: return <Users className="w-6 h-6" />;
            case 5: return <Wallet className="w-6 h-6" />;
            case 6: return <Target className="w-6 h-6" />;
            default: return null;
        }
    };
    ...
    const getStepTitle = (step) => {
        switch (step) {
            case 1: return 'اطلاعات تحصیلی';
            case 2: return 'تجربه شغلی';
            case 3: return 'مهارت‌های زبانی';
            case 4: return 'وضعیت خانوادگی';
            case 5: return 'بودجه و مقصد';
            case 6: return 'هدف مهاجرت';
            default: return '';
        }
    };
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl text-[#142738] mb-2">اطلاعات تحصیلی شما</h3>
                            <p className="text-[#64656f]">سن و سطح تحصیلات خود را مشخص کنید</p>
                        </div>

                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">سن شما</label>
                        ...
                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">آخرین مدرک تحصیلی</label>
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl text-[#142738] mb-2">تجربه کاری شما</h3>
                            <p className="text-[#64656f]">سابقه کار و حوزه شغلی خود را مشخص کنید</p>
                        </div>

                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">سابقه کار (سال)</label>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                                {['0', '1', '3', '6', '11'].map((exp) => (
                                    <button
                                        key={exp}
                        ...
                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">حوزه شغلی</label>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                {[
                                    'فناوری اطلاعات (IT)',
                                    'مهندسی',
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl text-[#142738] mb-2">مهارت‌های زبانی</h3>
                            <p className="text-[#64656f]">سطح زبان خارجی خود را مشخص کنید</p>
                        </div>

                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">نوع آزمون زبان</label>
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                                {[
                                    'IELTS',
                                    'TOEFL',
                        ...
                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">سطح زبان</label>
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl text-[#142738] mb-2">وضعیت خانوادگی</h3>
                            <p className="text-[#64656f]">اطلاعات خانواده خود را وارد کنید</p>
                        </div>

                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">وضعیت تأهل</label>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                        ...
                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">تعداد کل افراد (شامل شما)</label>
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl text-[#142738] mb-2">بودجه و کشور مقصد</h3>
                            <p className="text-[#64656f]">بودجه و کشور مورد علاقه خود را انتخاب کنید</p>
                        </div>

                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">بودجه تقریبی (دلار/یورو)</label>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                {[
                        ...
                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">کشور مورد علاقه</label>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                {[
                                    'کانادا',
                                    'استرالیا',
                ...
                return (
                    <div className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl text-[#142738] mb-2">هدف از مهاجرت</h3>
                            <p className="text-[#64656f]">هدف اصلی شما از مهاجرت چیست؟</p>
                        </div>

                        <div>
                            <label className="block text-[#142738] mb-3 font-medium">انتخاب هدف</label>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                {[
                                    { value: 'تحصیل', emoji: '🎓' },
                                    { value: 'کار', emoji: '💼' },
    ...
    if (showResults) {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white" dir="rtl">
                ...
                {/* Results Header */}
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12 lg:py-16">
                ...
                <div className="max-w-7xl mx-auto px-4 py-8 lg:py-12">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 mb-6">
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                            <h2 className="text-2xl text-[#142738]">خلاصه پروفایل شما</h2>
                            <button
                                onClick={() => {
                                    setShowResults(false);
                                    setCurrentStep(1);
                                }}
                                className="px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition-all"
                            >
                                ویرایش اطلاعات
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4">
                                <div className="text-[#64656f] text-sm mb-1">سن</div>
                                <div className="text-[#142738] font-medium">
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4">
                                <div className="text-[#64656f] text-sm mb-1">تحصیلات</div>
                                <div className="text-[#142738] font-medium">{profile.education}</div>
                            </div>
                            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4">
                                <div className="text-[#64656f] text-sm mb-1">زبان</div>
                                <div className="text-[#142738] font-medium">{profile.languageLevel}</div>
                            </div>
                            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-4">
                                <div className="text-[#64656f] text-sm mb-1">هدف</div>
                                <div className="text-[#142738] font-medium">{profile.immigrationGoal}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        {pathways.map((pathway) => (
                            <div
                                key={pathway.id}
                                className={`bg-white rounded-2xl shadow-lg p-6 lg:p-8 transition-all hover:shadow-xl ${
                                    pathway.recommended ? 'ring-2 ring-blue-500' : ''
                                }`}
                            >
                                {pathway.recommended && (
                                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-full text-sm mb-4">
                                ...
                                <div className="flex flex-col lg:flex-row justify-between items-start gap-4 mb-6">
                                    <div className="flex-1">
                                        <h3 className="text-xl lg:text-2xl text-[#142738] mb-3">{pathway.title}</h3>
                                        <div className="flex flex-wrap items-center gap-2">
                      <span className={`px-3 py-1 rounded-full text-sm ${getDifficultyColor(pathway.difficulty)}`}>
                        {pathway.difficulty}
                      </span>
                        ...
                        تطابق: {pathway.matchScore}%
                                    ...
                                    <div className="flex items-center gap-2 bg-gradient-to-br from-green-50 to-green-100 px-6 py-4 rounded-xl">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
                                    <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
                                        ...
                                        <div>
                                            <div className="text-[#64656f] text-sm mb-1">هزینه تقریبی</div>
                                            <div className="text-[#142738] font-medium">{pathway.cost}</div>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
                                        <Clock className="w-5 h-5 text-blue-600 mt-0.5" />
                                        <div>
                                            <div className="text-[#64656f] text-sm mb-1">مدت زمان</div>
                                            <div className="text-[#142738] font-medium">{pathway.duration}</div>
                                        </div>
                                    </div>
                                </div>

                                <div className="mb-6">
                                    <div className="flex items-center gap-2 text-[#142738] font-medium mb-3">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                        {pathway.requirements.map((req, idx) => (
                                            <div key={idx} className="flex items-start gap-2">
                                                ...
                                                <span className="text-[#64656f] text-sm">{req}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                        ...
                                        {pathway.timeline.map((item, idx) => (
                                            <div key={idx} className="flex gap-4 mb-4 last:mb-0">
                                                <div className="flex flex-col items-center">
                                                    <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-medium flex-shrink-0">
                                                        {idx + 1}
                                                    </div>
                                                ...
                                                <div className="flex-1 pb-4">
                                                    <div className="text-[#142738] font-medium mb-1">{item.step}</div>
                                                    <div className="text-sm text-[#64656f] bg-gray-50 px-3 py-1 rounded-full inline-block">
                                                        ⏱️ {item.duration}
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl p-4">
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                            {pathway.documents.map((doc, idx) => (
                                                <div key={idx} className="flex items-start gap-2">
                                                    <div className="w-5 h-5 bg-orange-500 text-white rounded flex items-center justify-center flex-shrink-0 text-xs font-medium mt-0.5">
                                                        {idx + 1}
                                                    </div>
                                                    <span className="text-[#142738] text-sm">{doc}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                        {pathway.officialLinks.map((link, idx) => (
                                            ...
                                            >
                                                <span className="text-[#142738] font-medium text-sm">{link.title}</span>
                                                <ExternalLink className="w-4 h-4 text-blue-600 group-hover:translate-x-[-4px] transition-transform" />
                                            </a>
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-3">
                                        {pathway.nextSteps.map((step, idx) => (
                                            <div key={idx} className="flex items-start gap-3 bg-blue-50 rounded-xl p-4">
                                                <div className="flex-shrink-0 w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-medium">
                                                    {idx + 1}
                                                </div>
                                                <span className="text-[#142738] flex-1">{step}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="pt-6 border-t border-gray-200">
                                    <button className="w-full lg:w-auto px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:shadow-lg transition-all transform hover:-translate-y-0.5">
                    ...
                    <div className="bg-yellow-50 border-r-4 border-yellow-400 rounded-xl p-6 mt-6">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[#64656f] text-sm leading-relaxed">
                                    این نتایج بر اساس الگوریتم هوشمند و اطلاعات عمومی تهیه شده و نمی‌تواند جایگزین مشاوره تخصصی حقوقی باشد.
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12 mt-8">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        ...
                        <button className="bg-white text-blue-600 px-8 py-4 rounded-xl hover:shadow-xl transition-all transform hover:-translate-y-1 font-medium">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 mb-6">
                    <div className="flex items-center justify-between mb-4">
                        <span className="text-[#142738] font-medium">قدم {currentStep} از {totalSteps}</span>
                        <span className="text-[#64656f] text-sm">{Math.round((currentStep / totalSteps) * 100)}% تکمیل شده</span>
                    </div>
