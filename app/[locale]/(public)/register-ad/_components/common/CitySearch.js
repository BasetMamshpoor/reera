  ...
  return (
    <div className="absolute top-10 px-4 w-full z-50 mx-auto ">
      <div className="relative w-full">
        <Search className="absolute top-1/2 -translate-y-1/2 start-2 fill-alpha-100 " />
        <input
          type="text"
          placeholder="ورودی"
          className="w-full   py-2 border bg-surface rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500  px-12 placeholder:text-alpha-100 focus:placeholder:opacity-0 "
          value={citySearch}
          onChange={(e) => {
