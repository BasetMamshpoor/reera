...
import { FormContext } from "@/app/[locale]/(public)/register-ad/_components/CategoriesList";
...
const DigitalPayment = ({ adId }) => {
  ...
  const ConditionMutation = useMutation({
    mutationFn: async (data) =>
      request({
        url: "store/digital/sixth",
        method: "post",
        data,
      }),

    onSuccess: () => {
      toast.success("Your Ad has been successfully submited");
