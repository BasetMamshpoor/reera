            ...
            <div className="border-b border-Gray-200 px-4 pt-4 pb-2">
                ...
                <div className="py-4 ">
                    <Tabs defaultValue={sort} onValueChange={setSort} className="w-full">
                        <TabsList
                            className="flex items-center gap-2 w-full h-auto bg-transparent p-0 overflow-x-auto scrollbar-hide">
                            <TabsTrigger
                                value="no_seen"
                    ...
                    data?.map((chat) => (
                        ...
                        >
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex items-center gap-2">
                                    <div
                                        className="w-12 h-12 bg-Gray-200 rounded-lg border-2 border-dashed border-Gray-300 flex items-center justify-center flex-shrink-0">
                                        <Image
                                            src={chat.image}
                                            alt="image"
                                            width={48}
