...
const Resume = () => {
  ...
  const tabs = [
    ...
    { id: 2, label: r.consultation_rate },
        ...
        {tabs.map(({ id, label }) => {
          ...
          return (
            <button
              ...
              className={`w-34 py-2 rounded-lg border cursor-pointer transition-all duration-200 ${
                isActive
            ...
            {previewUrl && (
              <div className="flex flex-col gap-3 w-full max-w-lg rtl:items-end">
                <div className="flex items-center justify-between w-full">
                  <h3 className="text-Gray-600 font-medium">{r.preview}</h3>
                  <button
                    onClick={removeFile}
