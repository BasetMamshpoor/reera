...
const Details = () => {
    ...
    const d = dic.consultor.dashboard
    const b = dic.consultor.consultant_request
    return (
        <>
            <div
                ...
                <div className="hidden lg:flex items-center gap-2 p-5 border-b dark:border-[#374151] border-gray-200">
                    <User className="fill-gray-800 dark:fill-gray-200"/>
                    <p className="text-xl dark:text-[#E0E2E5] text-black font-bold">{b.consultant_request}</p>
                </div>
