...
const Card = ({
  ...
  return (
    <>
      {isRow ? (
        <Link
          href={`/${locale}/ads/ticket/${id}`}
          className="flex md:p-6 gap-1 md:gap-6 bg-transparent rounded-xl [box-shadow:0_2px_32px_0_rgba(28,_28,_28,_0.06)] w-full h-fit "
        >
        ...
        <Link
          href={`/${locale}/ads/ticket/${id}`}
          className="flex flex-row gap-4 p-2.5 h-42  w-full bg-transparent rounded-lg border border-default-divider [box-shadow:0_2px_32px_0_rgba(28,_28,_28,_0.06)] cursor-pointer"
        >
