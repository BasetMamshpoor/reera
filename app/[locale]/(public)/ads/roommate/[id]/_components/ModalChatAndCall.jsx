                    ...
                    <form>
                        <DialogTrigger asChild>
                            <Button variant="outline"
                                ...
                                <p className="text-base text-Primary-400 whitespace-nowrap pt-2">{data?.contact.site_massage ? a.chat_call : a.call}</p>
                            </Button>
                        </DialogTrigger>
                        <DialogContent className="flex flex-col justify-between gap-10 p-10 h-fit">
                            <div className="flex flex-col gap-10 pt-4 w-full">
                                <p className="lg:text-lg text-Primary-950 font-semibold pt-1">{a.contact_and_chat}</p>
                                <Accordion
                                    type="single"
                                    collapsible
