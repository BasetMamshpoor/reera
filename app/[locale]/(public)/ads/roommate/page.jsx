...
const Page = async ({ searchParams }) => {
  ...
  await queryClient.prefetchQuery({
    queryKey: ["roommate-ads", page],
    queryFn: async () =>
      await request({
        url: `/ads?category_slug=roommate`,
        method: "get",
        query: { page },
      }),
  });
        ...
        <div className="flex gap-6">
          <Providers dehydratedState={dehydrate(queryClient)}>
            <div className="flex flex-col gap-6">
              <RoommateSidebar />
              {/* <div className="flex items-center gap-2 bg-white dark:bg-[#252C36] border border-[#D1D5DB] dark:border-[#374151] rounded-xl max-w-120 ">
