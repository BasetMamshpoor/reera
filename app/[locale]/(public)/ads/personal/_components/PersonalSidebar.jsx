...
const PersonalSidebar = () => {
  ...
  const p = dic.public.filters.personal;

  const categories = [
    p.bags_shoes_clothing,
    p.jewelry_accessories,
    p.cosmetics_hygiene_health,
    p.kids_shoes_clothing,
    p.kids_items_toys,
    p.stationery,
  ];
    ...
    <>
      <div className="border-2 h-fit border-default-divider hidden lg:block bg-transparent rounded-xl w-full max-w-92">
        <div className="flex flex-col gap-4 p-6">
          ...
          <PersonalFilterContent {...sharedProps} />
        </div>
      </div>
