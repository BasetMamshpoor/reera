        ...
        <>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 w-full">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        >
                            ...
                            <TabsContent value="password">
                                <Facilities data={data?.data} isLoading={isLoading} a={a}/>
                            </TabsContent>
                        ...
                        <div className="flex lg:hidden flex-col gap-10">
                            <InformationAd refetch={refetch} data={data?.data} isLoading={isLoading} locale={locale}
                                           a={a}/>
                ...
                <div className="hidden lg:flex w-full">
                    <InformationAd refetch={refetch} data={data?.data} isLoading={isLoading} locale={locale} a={a}/>
                </div>
            </div>
        </>
    );
