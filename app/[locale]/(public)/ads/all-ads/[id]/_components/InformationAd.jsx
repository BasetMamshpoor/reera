...
const InformationAd = ({a, locale, data, isLoading}) => {
            ...
            <div className="w-full">
                <div
                    ...
                    <div className="flex flex-col gap-6 bg-surface p-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-between w-full">
                                <div
                                    className="lex items-center justify-center px-2 py-1 bg-surface rounded-lg text-xs text-Primary-400 w-fit">
                                    {data?.seller.is_iran ? a.iranian_owner : a.non_iranian_owner}
                                </div>
                        ...
                        <div
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-sm text-secondary font-bold">{data?.seller.name}</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-sm text-gray-950 dark:text-gray-50">{data?.time}</p>
                                </div>
                                <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <Select onValueChange={(val) => handleCurrencyChange(val, "donation")}>
                                    ...
                                    <SelectContent>
                                        <SelectGroup>
                                            <SelectItem value="IRT">{a.currency_toman}</SelectItem>
                                            <SelectItem value="USD">{a.currency_dollar}</SelectItem>
                                            <SelectItem value="EUR">{a.currency_euro}</SelectItem>
                                        </SelectGroup>
                                    </SelectContent>
                                </Select>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <p className="text-sm text-Gray-700">{a.total_amount}</p>
                            <div className="flex items-center gap-1">
                                <p className="text-Primary-950 font-bold text-xl">
                                    {mutation.isPending ?
                    ...
                    <Link href="/"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-lg text-[#3B3E46] dark:text-[#E0E2E5] font-bold">{data?.seller.name}</p>
                            </div>
                            <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-base text-gray-950 dark:text-gray-50">{data?.time}</p>
                            </div>
                            <div className="flex items-center gap-2">
