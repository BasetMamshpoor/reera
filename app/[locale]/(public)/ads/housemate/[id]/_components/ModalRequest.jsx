            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogTrigger asChild>
                    <Button
                        type="button"
                        variant="outline"
                        className="border-none shadow-none py-2 hover:bg-Primary-400 flex items-center justify-center gap-2 w-full bg-Primary-400 dark:bg-Primary-400 rounded-xl px-5 cursor-pointer"
                    >
                        <p className="text-base text-white whitespace-nowrap">{a.request_submission}</p>
                    </Button>
                </DialogTrigger>
