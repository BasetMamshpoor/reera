    ...
    <>
      <div className="relative lg:hidden select-none">
        ...
        >
          {hasImages ? (
            images.slice(0, 4).map((item, index) => (
              <SwiperSlide key={index} className="relative">
                ...
                />
                <div className="absolute top-3 right-3 flex items-center gap-1 bg-Gray-200 text-Gray-700 text-sm px-3 rounded-lg">
          ...
          <div className="swiper-pagination-ads absolute bottom-3 left-0  right-0 flex justify-center items-center gap-2 z-10 w-full bg-transparent"></div>
        </Swiper>
      </div>
          ...
          <div className="grid grid-cols-3 grid-rows-2 gap-6 w-full max-h-[520px] h-full">
            ...
            {images[2] && (
              ...
              >
                ...
                />
                {images.length > 3 && (
                  <div className="absolute inset-0 bg-black/60 w-full h-full flex border border-default-divider items-center justify-center">
                    <div className="relative !w-10 !h-10">
                      <Image
                        ...
                        className="w-full h-full"
                      />
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-base font-semibold whitespace-nowrap">
                        {images.length - 3} +
                      </div>
                    </div>
                  </div>
