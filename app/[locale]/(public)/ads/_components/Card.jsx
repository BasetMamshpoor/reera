    ...
    return (
        <>
            {isRow ? (
                ...
                (
                    <div
                        className="grid grid-rows-2 bg-surface rounded-xl overflow-hidden [box-shadow:0_2px_32px_0_rgba(28,_28,_28,_0.06)] w-full max-h-[500px] h-full">
                        ...
                        <div className="relative z-10 flex flex-col justify-between px-4 md:p-5 md:pt-0 gap-4 h-full">
