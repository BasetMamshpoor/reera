        ...
        <>
            <div className=" hidden lg:block max-w-[360px] w-full">
                {filtersLoading || !filters ?
                    ...
                    <div className=" border-2 border-default-divider rounded-xl bg-transparent w-full h-fit">
                    ...
                    {activeFilters?.map((f) => (
                        <button
                            ...
                            onClick={() => {
                                ...
                                } else if (f.key === "function_range") {
                                    handleChange("min_function", functionRangeFromAPI.min);
                                    handleChange("max_function", functionRangeFromAPI.max);
