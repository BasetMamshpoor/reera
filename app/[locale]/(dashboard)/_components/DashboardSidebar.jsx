...
const DashboardSidebar = () => {
  ...
  return (
    <div className="flex flex-col gap-8 border border-[#D1D5DB] dark:border-[#374151] bg-[#F9FAFB] dark:bg-[#14181D] rounded-2xl [box-shadow:0_2px_32px_0_rgba(28,_28,_28,_0.06)] w-full max-w-80 h-fit sticky top-4">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-1">
                  ...
                  <p className="text-Gray-700 text-xs">300 {p.toman}</p>
                </div>
                <Modal />
              </div>
            </div>
