...
const Home = ({data, isLoading, refetch, tab, favorite}) => {
    ...
    return (
        <>
            {data?.data.map((item) => item.model === "Recruitment" ? "" :
                <div key={item.id}
                     className="flex flex-col pb-4 bg-surface rounded-xl overflow-hidden w-full h-full dark:border dark:border-Gray-100">
