...
const Home = ({data, isLoading, refetch, tab, favorite}) => {
    ...
    return (
        <>
            {data?.data.map((item) => item.model === "Recruitment" ? "" : <div key={item.id}
                                                                               className="flex flex-col pb-4 bg-surface rounded-xl overflow-hidden w-full dark:border dark:border-Gray-100">
                ...
                <div className="flex flex-col justify-between px-4 gap-4 w-full pt-2">
                    ...
                    {favorite === 1 ? null : <div className="flex items-center justify-center w-full gap-4">
