      ...
      <form>
        ...
        <DialogContent className="sm:max-w-[425px] rtl:text-right">
          ...
          <DialogFooter className="w-full items-center gap-3">
            <DialogClose asChild>
              <Button className="flex items-center justify-center  bg-white hover:bg-transparent dark:bg-black py-2 border border-[#F59E0B] rounded-xl w-1/2 text-[#F59E0B] text-base font-bold">
                {d.Cancellation}
              </Button>
            </DialogClose>
            <button className="flex gap-2 items-center justify-center px-3 py-2 w-1/2 bg-[#4299C1] rounded-xl text-white dark:text-black whitespace-nowrap text-base font-bold">
              <p> {d.inventory}</p>
            </button>
          </DialogFooter>
        </DialogContent>
