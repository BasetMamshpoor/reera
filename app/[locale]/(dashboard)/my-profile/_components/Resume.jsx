                        ...
                        SVG, PNG, JPG or GIF (max. 800x400px)
                                    ...
                                    {previewUrl && (
                                        <div className="flex flex-col gap-3 w-full max-w-lg rtl:items-end">
                                            ...
                                            <div
                                                className="border border-default-divider rounded-lg p-3 bg-alphaw-100 w-full">
                                    ...
                                    {selectedFile &&
                                        ...
                                        !previewUrl && (
                                            <div className="flex flex-col gap-3 w-full max-w-lg rtl:items-end">
                                                ...
                                                <div
                                                    className="border border-default-divider rounded-lg p-4 bg-alphaw-100 w-full">
                                    ...
                                    <div
                                        className="flex flex-row ltr:justify-end rtl:flex-row-reverse  items-center w-full  gap-6 mt-auto ">
                                        <button
                                            type="button"
