                        ...
                        <div key={lang.id} className="relative rounded-lg">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 w-full">
                                ...
                                <div className="w-full">
                                    ...
                                    >
                                        <SelectTrigger
                                            className="border py-5 border-default-divider cursor-pointer w-full rounded-lg px-3 text-gray-500 text-sm lg:text-base">
                                ...
                                <div className="w-full">
                                    ...
                                    >
                                        <SelectTrigger
                                            className="w-full [&_[data-slot=chev-down]]:fill-Gray-500 border border-default-divider py-5 rounded-lg data-[placeholder]:text-Gray-500">
