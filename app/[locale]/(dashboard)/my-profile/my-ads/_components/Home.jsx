  ...
  return (
    <>
      {data?.data.map((item) => (
        <div
          key={item.id}
          className="flex flex-col pb-4 bg-white dark:bg-surface rounded-xl overflow-hidden w-full dark:border dark:border-Gray-100"
        >
          ...
          <div className="flex flex-col px-4 justify-between h-full gap-4 w-full pt-2">
            ...
            {item.status === "pending" || item.status === "approved" ? (
              ...
              <div className="flex items-center col-span-3 gap-2 justify-center py-2 bg-Gray-400 border rounded-xl w-full  text-alphaw-40 text-sm lg:text-base font-bold">
