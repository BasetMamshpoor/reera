                ...
                <TableBody className="border-0">
                    {data?.map((i) => (
                        <TableRow key={i.id}>
                            ...
                            {/*    </div>*/}
                            {/*</TableCell>*/}
                            <TableCell className="text-Gray-800 text-base">{i.type}</TableCell>
                            <TableCell className="text-Gray-800 text-base">
                                {(i.amount).toLocaleString()} تومان
                            </TableCell>
                            <TableCell className="text-Gray-800 text-base">{i.date} {" /"} {i.time}</TableCell>
                            <TableCell className="flex items-center justify-center">
                                {i.status === "successful" ? <Badge
