            ...
            <div className="flex flex-col items-center justify-center w-full gap-4 pb-6">
                ...
                <div className="flex flex-col items-center justify-center w-full h-full gap-10">
                    ...
                    <div className={`flex items-center justify-center gap-6 w-full`}>
                        <div
                            className="flex items-center justify-center gap-2 py-2 px-6 border border-Primary-400 rounded-xl w-fit text-Primary-400 text-base font-bold">
                            <Search className="fill-primary-400"/>
                            <p className="pt-2">{a.search_ad}</p>
                        </div>
                    </div>
                </div>
            </div>
