...
const JobEmpleymentRequests = () => {
    const params = useParams();
    const locale = params.locale;
    return (
        <div className="p-8 w-full">
            <div className="bg-Surface-2 w-full flex flex-col gap-4 p-6 rounded-xl">
                <div className="flex items-center gap-4 px-4 lg:px-6 xl:flex-row flex-col w-full ">
                ...
                <div className="px-4 lg:block hidden">
                    <Table>
                      ...
                      محمد حسینی.pdf{" "}
                                ...
                                <TableCell className={``}>
                                    <Link
                                        href={`/${locale}/profile/employee/1`}
                                ...
                                <TableCell className="">
                                    <div className="flex items-center justify-center gap-2">
                                        <button
                                            className="w-18 flex items-center justify-center gap-1 text-sm font-bold rounded-2xl border-2 border-success-main text-success-main px-2 py-2 cursor-pointer">
                                            <span className="text-center">تایید</span>
                                            <Tick className="fill-success-main"/>
                                        </button>
                                        <button
                                            className="w-16 flex items-center justify-center gap-1 text-sm font-bold rounded-2xl border-2 border-error-main text-error-main px-2 py-2 cursor-pointer">
                ...
                <div className="px-4 lg:hidden block">
                    <div className="w-full border border-default-divider rounded-tr-2xl rounded-tl-2xl">
                        <div
                            className="flex items-center justify-around bg-Primary-100 gap-12 py-4 rounded-tr-2xl rounded-tl-2xl border-b border-b-default-divider">
                                ...
                                <AccordionContent>
                                    <div className="grid grid-cols-1 gap-4 p-4">
                                        ...
                                        <div className="flex items-center gap-2 flex-1 justify-center w-full">
                                            <button
                                                className="w-full flex items-center justify-center gap-1 text-sm font-bold rounded-2xl border-2 border-success-main text-success-main px-2 py-2 cursor-pointer">
                                                <Tick className="fill-success-main"/>
                                                <span className="text-center">تایید</span>
                                            </button>
                                            <button
                                                className="w-full flex items-center justify-center gap-1 text-sm font-bold rounded-2xl border-2 border-error-main text-error-main px-2 py-2 cursor-pointer">
                                                <Close className="fill-error-main"/>
                                                <span className="text-center">رد</span>
                                            </button>
                                        </div>
...
export default JobEmpleymentRequests;
